...
const tld = '.gujju';
const CONTRACT_ADDRESS = '0x8EB7310FF029C64B4Ce0ccE0346E5A16c3a6ea60';
...
const editRecord = (name) => {
	...
	const renderNotConnectedContainer = () => (
		<div className="connect-wallet-container">
			<img src="https://media.giphy.com/media/5PL7uAyt40LFfrHEkG/giphy.gif" alt="gujju gif" />
		...
		return (
			<div className="form-container">
				...
				<input
					type="text"
					value={record}
					placeholder='ભાઈ, કયું ગામ તમારું?'
		...
		<div className="App">
			<div className="container">
				...
				<div className="header-container">
					<header>
						<div className="left">
							<p className="title">👳 Gujju Naming Service</p>
              <p>---------------------------------------------------------------------------------------</p>
              <p className="subtitle">--> કેમ છો? 👋</p>
              <p className="subtitle">--> Polygon blockchain ઉપર તમારું નામ રજીસ્ટર કરો !</p>
						</div>
